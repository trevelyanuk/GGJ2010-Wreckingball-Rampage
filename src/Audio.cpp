...
void
CAudio::setListenerLookAt(float x_,float y_, float z_)
{
...
void 
CAudio::setListenerPosition(float x_,float y_, float z_)
{
	// Position of the listener.
...
int 
CAudio::playSound(char * filename_,float x, float y, float z, bool brepeat_, bool relativeToListener_)
{
    ...
    alSourcef (source[sourceNumber], AL_GAIN,     1.0f     );
...
void
CAudio::setVolume(int sourceNumber_,float value_)
{
float value;
if (value_<=0.0)
{
